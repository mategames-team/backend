...
public class RawgApiClient {
    ...
    private static final String PAGE_URL_PART = "&page=1";
    private static final String PAGE_SIZE_URL_PART = "&page_size=100";
    private static final String ORDERING_URL_PART = "&ordering=-rating";
    @Value("${rawg.key}")
    private String apiKey;
    private final ObjectMapper objectMapper;
    private final HttpClient httpClient;

    public List<ApiResponseGameDto> getAllGames() {
        String url = BASE_URL + GAME_URL_PART
                + KEY_URL_PART + apiKey
                + PAGE_URL_PART + PAGE_SIZE_URL_PART + ORDERING_URL_PART;
